...
<div id="content">
<form action="sch_forgotpsw_loc.php" method="post" onsubmit="return formValidation()">
   <h3>Re-create your password</h3>
   <div id="line"></div>
  <input type="text" name="sid" size="25" placeholder="Enter your registered School id..."required /><br>
